...
class lanenet_detector():
    ...
    def gradient_thresh(self, img, thresh_min=15, thresh_max=255):
        """
    ...
    def color_thresh(self, img, thresh=(25, 255)):
        """
        ...
        s_channel = col[:, :, 2]
        _,col_output = cv2.threshold(s_channel, thresh[0], thresh[1], cv2.THRESH_BINARY)
    ...
    def perspective_transform(self, img, verbose=False):
        ...
        #bag 830:
        src = np.float32([[500, 405], [730, 405], [240, 695], [1000, 690]])
