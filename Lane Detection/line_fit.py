...
def line_fit(binary_warped):
	...
	for window in range(nwindows):
		...
		## TODO
		left_x1 = leftx_current - margin_l
		left_x2 = leftx_current + margin_l
		left_y1 = window * window_height
		left_y2 = (window + 1)* window_height

		right_x1 = rightx_current - margin_r
		right_x2 = rightx_current + margin_r 
		right_y1 = left_y1
		right_y2 = left_y2
		####
		...
		## TODO
		color = (0, 255, 0)
		start_point1 = (left_x1, left_y1)
		start_point2 = (right_x1, right_y1)
		end_point1 = (left_x2, left_y2)
		end_point2 = (right_x2, right_y2)
		...
		## TODO
		window_l = binary_warped[left_y1 : left_y2 , left_x1 : left_x2]
		window_r = binary_warped[right_y1 : right_y2 , right_x1 : right_x2]
		nonzero_l = ((nonzeroy >= left_y1) & (nonzeroy <= left_y2) & (nonzerox >= left_x1) & (nonzerox <= left_x2)).nonzero()[0]
		nonzero_r = ((nonzeroy >= right_y1) & (nonzeroy <= right_y2) & (nonzerox >= right_x1) & (nonzerox <= right_x2)).nonzero()[0]	
		####
